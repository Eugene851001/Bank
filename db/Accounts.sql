...
/*  Created On : 08-фев-2022 13:31:07 				*/
...
ALTER TABLE [Contracts] DROP CONSTRAINT [FK_Contracts_DepositsPlans]
GO
...
ALTER TABLE [Contracts] ADD CONSTRAINT [FK_Contracts_DepositsPlans]
